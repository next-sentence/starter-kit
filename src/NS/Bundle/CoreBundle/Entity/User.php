 ...
 * Class User
 */
class User implements AdvancedUserInterface, ResourceInterface, \Serializable, TimestampableInterface, ToggleableInterface
{
     ...
     * @var array
     */
    protected $roles = [self::DEFAULT_ROLE];
    ...
    public function getOAuthAccount($provider)
    {
        ...
        $filtered = $this->oauthAccounts->filter(function (UserOAuth $oauth) use ($provider) {
     ...
     * {@inheritdoc}
     */
    public function addOAuthAccount(UserOAuth $oauth)
    {
